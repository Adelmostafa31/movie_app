...
class horror_category_screen extends StatelessWidget {
  const horror_category_screen({Key? key, required this.cubit}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return ListView.builder(
      itemBuilder: (context, index) => SizedBox(
        height: height*0.53,
        child:  list_view_category_item(movie: cubit.horror_list[index],)
      ),
      itemCount: cubit.horror_list.length,
